/* Generated by GOB (v2.0.6) on Mon Jan  5 18:38:04 2004
...
static void xfce_mixer_settingsbox_device_changed_t_cb (XfceMixerSettingsbox * self, GtkTreePath * arg1, GtkTreeViewColumn * arg2, gpointer user_data) G_GNUC_UNUSED;
...
static void (* const self_device_changed_t_cb) (XfceMixerSettingsbox * self, GtkTreePath * arg1, GtkTreeViewColumn * arg2, gpointer user_data) = xfce_mixer_settingsbox_device_changed_t_cb;
...
#line 6 "mixer-settingsbox.gob"
	self->dev_frame = NULL;
#line 161 "xfce-mixer-settingsbox.c"
#line 6 "mixer-settingsbox.gob"
	self->dev_label = NULL;
...
#line 29 "mixer-settingsbox.gob"
		...
		self->dev_label = GTK_LABEL (gtk_label_new (""));
		...
		gtk_box_pack_start (GTK_BOX (self->right_box), GTK_WIDGET (self->useful_frame), TRUE, FALSE, 0);
		...
		g_signal_connect_swapped (G_OBJECT (self->devlist_tv), "row-activated", G_CALLBACK (self_device_changed_t_cb), self);
...
#line 272 "xfce-mixer-settingsbox.c"
 }
	return;
	self = NULL;
}
...
#line 284 "xfce-mixer-settingsbox.c"
{
...
{
#line 103 "mixer-settingsbox.gob"
	
		self_device_changed_cb (self);
	}}
#line 297 "xfce-mixer-settingsbox.c"
#undef __GOB_FUNCTION__

#line 107 "mixer-settingsbox.gob"
static void 
xfce_mixer_settingsbox_device_changed_t_cb (XfceMixerSettingsbox * self, GtkTreePath * arg1, GtkTreeViewColumn * arg2, gpointer user_data)
#line 303 "xfce-mixer-settingsbox.c"
{
...
#line 107 "mixer-settingsbox.gob"
	g_return_if_fail (XFCE_IS_MIXER_SETTINGSBOX (self));
#line 310 "xfce-mixer-settingsbox.c"
{
#line 112 "mixer-settingsbox.gob"
...
#line 116 "mixer-settingsbox.gob"
void 
...
{
#line 117 "mixer-settingsbox.gob"
		...
		gtk_tree_selection_get_selected (sels, &m, &iter);
...
#line 164 "mixer-settingsbox.gob"
	g_return_if_fail (XFCE_IS_MIXER_SETTINGSBOX (self));
#line 391 "xfce-mixer-settingsbox.c"
{
...
#line 190 "mixer-settingsbox.gob"
XfceMixerSettingsbox * 
xfce_mixer_settingsbox_new (void)
#line 438 "xfce-mixer-settingsbox.c"
{
