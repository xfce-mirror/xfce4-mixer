...
#line 128 "xfce-mixer-switch.c"
{
#define __GOB_FUNCTION__ "Xfce:Mixer:Switch::init"
#line 7 "mixer-switch.gob"
	self->button = NULL;
#line 133 "xfce-mixer-switch.c"
 {
