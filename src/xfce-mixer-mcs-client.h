...
#define xfce_mixer_mcs_client_connect__changed(object,func,data)	g_signal_connect(XFCE_MIXER_MCS_CLIENT(({XfceMixerMcsClient *___object = (object); ___object; })),"changed",(GCallback)({void (* ___changed) (XfceMixerMcsClient * self, gpointer ___data ) = (func); ___changed; }), (data))
#define xfce_mixer_mcs_client_connect_after__changed(object,func,data)	g_signal_connect_after(XFCE_MIXER_MCS_CLIENT(({XfceMixerMcsClient *___object = (object); ___object; })),"changed",(GCallback)({void (* ___changed) (XfceMixerMcsClient * self, gpointer ___data ) = (func); ___changed; }), (data))
#define xfce_mixer_mcs_client_connect_data__changed(object,func,data,destroy_data,flags)	g_signal_connect_data(XFCE_MIXER_MCS_CLIENT(({XfceMixerMcsClient *___object = (object); ___object; })),"changed",(GCallback)({void (* ___changed) (XfceMixerMcsClient * self, gpointer ___data ) = (func); ___changed; }), (data), (destroy_data), (GConnectFlags)(flags))
 ...
 */
#if defined(__GNUC__) && !defined(__STRICT_ANSI__)
#define XFCE_MIXER_MCS_CLIENT_PROP_CHANNEL(arg)    	"channel",({gchar *z = (arg); z;})
#define XFCE_MIXER_MCS_CLIENT_GET_PROP_CHANNEL(arg)	"channel",({gchar **z = (arg); z;})
#else /* __GNUC__ && !__STRICT_ANSI__ */
