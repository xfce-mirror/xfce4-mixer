/* Generated by GOB (v2.0.6) on Wed Feb 11 20:17:35 2004
...
#line 198 "mixer-window.gob"
		...
		xwindow = GDK_WINDOW_XID (GTK_WIDGET (self)->window);

		g_warning ("xwindow %ld", xwindow);

		win = netk_window_get (xwindow);
		...
		xfce_mixer_pxml_set_prop_int (xml, "sticky", netk_window_is_sticky (win));
		/*, selfp->sticky ? 1 : 0); */

		g_object_unref (G_OBJECT (xml));
		g_object_unref (G_OBJECT (win));
	}}
#line 526 "xfce-mixer-window.c"
#undef __GOB_FUNCTION__

#line 258 "mixer-window.gob"
gboolean 
...
#line 258 "mixer-window.gob"
	g_return_val_if_fail (XFCE_IS_MIXER_WINDOW (self), (gboolean )0);
#line 539 "xfce-mixer-window.c"
{
#line 259 "mixer-window.gob"
	
		self_save_window_state(self);
		return FALSE;
	}}
#line 546 "xfce-mixer-window.c"
#undef __GOB_FUNCTION__

#line 264 "mixer-window.gob"
void 
xfce_mixer_window_mcs_changed_cb (XfceMixerWindow * self, GtkWidget * widget)
#line 552 "xfce-mixer-window.c"
{
...
#line 264 "mixer-window.gob"
	g_return_if_fail (XFCE_IS_MIXER_WINDOW (self));
#line 559 "xfce-mixer-window.c"
{
#line 265 "mixer-window.gob"
...
#line 639 "xfce-mixer-window.c"
#undef __GOB_FUNCTION__

#line 315 "mixer-window.gob"
void 
xfce_mixer_window_update_profiles_menu (XfceMixerWindow * self)
#line 645 "xfce-mixer-window.c"
{
...
#line 315 "mixer-window.gob"
	g_return_if_fail (XFCE_IS_MIXER_WINDOW (self));
#line 652 "xfce-mixer-window.c"
{
#line 316 "mixer-window.gob"
...
#line 407 "mixer-window.gob"
GtkWidget * 
xfce_mixer_window_new (void)
#line 751 "xfce-mixer-window.c"
{
...
#line 759 "xfce-mixer-window.c"
#undef __GOB_FUNCTION__

#line 412 "mixer-window.gob"
void 
xfce_mixer_window_refresh (XfceMixerWindow * self)
#line 765 "xfce-mixer-window.c"
{
...
{
#line 413 "mixer-window.gob"
	
		if (self->profile)
			xfce_mixer_profile_refresh_views (self->profile);
	}}
#line 779 "xfce-mixer-window.c"
#undef __GOB_FUNCTION__
...
#line 806 "xfce-mixer-window.c"
#undef __GOB_FUNCTION__

#line 431 "mixer-window.gob"
void 
xfce_mixer_window_refresh_value (XfceMixerWindow * self, gchar const * vcname)
#line 812 "xfce-mixer-window.c"
{
...
#line 431 "mixer-window.gob"
	g_return_if_fail (XFCE_IS_MIXER_WINDOW (self));
#line 819 "xfce-mixer-window.c"
{
#line 432 "mixer-window.gob"
	
		if (self->view)
			xfce_mixer_view_refresh_value (self->view, vcname);
	}}
#line 826 "xfce-mixer-window.c"
#undef __GOB_FUNCTION__
