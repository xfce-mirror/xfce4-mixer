...
#define xfce_mixer_view_connect__profile_changed(object,func,data)	g_signal_connect(XFCE_MIXER_VIEW(__extension__ ({XfceMixerView *___object = (object); ___object; })),"profile_changed",(GCallback) __extension__ ({void (* ___profile_changed) (XfceMixerView * ___fake___self, gpointer ___data ) = (func); ___profile_changed; }), (data))
#define xfce_mixer_view_connect_after__profile_changed(object,func,data)	g_signal_connect_after(XFCE_MIXER_VIEW(__extension__ ({XfceMixerView *___object = (object); ___object; })),"profile_changed",(GCallback) __extension__ ({void (* ___profile_changed) (XfceMixerView * ___fake___self, gpointer ___data ) = (func); ___profile_changed; }), (data))
#define xfce_mixer_view_connect_data__profile_changed(object,func,data,destroy_data,flags)	g_signal_connect_data(XFCE_MIXER_VIEW(__extension__ ({XfceMixerView *___object = (object); ___object; })),"profile_changed",(GCallback) __extension__ ({void (* ___profile_changed) (XfceMixerView * ___fake___self, gpointer ___data ) = (func); ___profile_changed; }), (data), (destroy_data), (GConnectFlags)(flags))
