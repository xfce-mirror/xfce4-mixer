/* Generated by GOB (v2.0.6) on Wed Jan 28 21:04:26 2004
...
#line 276 "mixer-view.gob"
		...
		g_warning ("set_profile entered");

		if (p) {
			g_object_ref (G_OBJECT (p));
			g_warning ("ref profile %X %s", (int)p, xfce_mixer_profile_get_title (p));
		}
