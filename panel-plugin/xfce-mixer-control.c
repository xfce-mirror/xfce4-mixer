...
#line 42 "xfce-mixer-control.c"

#line 17 "mixer-control.gob"

#include <gtk/gtk.h>

#line 48 "xfce-mixer-control.c"
/* self casting macros */
...
#line 164 "xfce-mixer-control.c"
#line 130 "mixer-control.gob"
	if(self->vcname) { ((*(void (*)(void *))g_free)) (self->vcname); self->vcname = NULL; }
#line 167 "xfce-mixer-control.c"
#line 133 "mixer-control.gob"
	if(self->value) { ((*(void (*)(void *))g_free)) (self->value); self->value = NULL; }
#line 170 "xfce-mixer-control.c"
	return;
	self = NULL;
}
...
#line 92 "mixer-control.gob"
	self->location = NULL;
#line 245 "xfce-mixer-control.c"
#line 92 "mixer-control.gob"
	self->orderno = 0;
#line 248 "xfce-mixer-control.c"
#line 125 "mixer-control.gob"
	self->vcname = NULL;
#line 251 "xfce-mixer-control.c"
#line 125 "mixer-control.gob"
	self->value = NULL;
#line 254 "xfce-mixer-control.c"
	return;
	self = NULL;
}
#undef __GOB_FUNCTION__
...
#line 293 "xfce-mixer-control.c"
		}
		break;
	case PROP_VALUE:
		{
#line 139 "mixer-control.gob"
...
#line 377 "xfce-mixer-control.c"
		}
		break;
	case PROP_VCNAME:
		{
#line 164 "mixer-control.gob"

			g_value_set_string (VAL, self->vcname);
		
#line 386 "xfce-mixer-control.c"
		}
		break;
	default:
/* Apparently in g++ this is needed, glib is b0rk */
 ...
 **/
#line 38 "mixer-control.gob"
gchar * 
xfce_mixer_control_calc_sanename (XfceMixerControl * self)
#line 417 "xfce-mixer-control.c"
{
...
#line 587 "xfce-mixer-control.c"
#undef __GOB_FUNCTION__

#line 148 "mixer-control.gob"
gchar * 
xfce_mixer_control_get_value (XfceMixerControl * self)
#line 593 "xfce-mixer-control.c"
{
...
#line 613 "xfce-mixer-control.c"
#undef __GOB_FUNCTION__

#line 164 "mixer-control.gob"
gchar * 
xfce_mixer_control_get_vcname (XfceMixerControl * self)
#line 619 "xfce-mixer-control.c"
{
