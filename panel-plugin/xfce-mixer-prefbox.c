...
#line 48 "mixer-prefbox.gob"
	if(self->ic) { ((*(void (*)(void *))destroy_command_options)) (self->ic); self->ic = NULL; }
#line 193 "xfce-mixer-prefbox.c"
	g_free (priv);
	return;
	self = NULL;
}
