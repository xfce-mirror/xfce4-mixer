/* Generated by GOB (v2.0.6) on Thu Jan  8 17:18:09 2004
...
#line 31 "xfce-mixer-preferences.c"

#line 7 "mixer-preferences.gob"
...
#line 45 "xfce-mixer-preferences.c"

#line 18 "mixer-preferences.gob"

#include "xfce-mixer-pxml.h"

#line 51 "xfce-mixer-preferences.c"
/* self casting macros */
...
#line 42 "mixer-preferences.gob"
	if(self->xml) { ((*(void (*)(void *))g_object_unref)) (self->xml); self->xml = NULL; }
#line 150 "xfce-mixer-preferences.c"
	return;
	self = NULL;
}
...
#line 24 "mixer-preferences.gob"
	if(self->device) { ((*(void (*)(void *))g_free)) (self->device); self->device = NULL; }
#line 167 "xfce-mixer-preferences.c"
...
#line 282 "xfce-mixer-preferences.c"
 {
#line 170 "mixer-preferences.gob"
...
#line 340 "xfce-mixer-preferences.c"
		}
		break;
	case PROP_EXECU:
		{
...
#line 353 "xfce-mixer-preferences.c"
		}
		break;
	case PROP_IN_TERMINAL:
		{
#line 98 "mixer-preferences.gob"
self->in_terminal = g_value_get_boolean (VAL);
#line 360 "xfce-mixer-preferences.c"
		}
		break;
	case PROP_STARTUP_NF:
		{
#line 102 "mixer-preferences.gob"
self->startup_nf = g_value_get_boolean (VAL);
#line 367 "xfce-mixer-preferences.c"
		}
		break;
	default:
...
#define __GOB_FUNCTION__ "Xfce:Mixer:Preferences::get_property"
{
	...
	case PROP_DEVICE:
		{
#line 60 "mixer-preferences.gob"

		g_value_set_string (VAL, self->device);
	
#line 404 "xfce-mixer-preferences.c"
		}
		break;
	case PROP_MASTER:
		{
...
#line 432 "xfce-mixer-preferences.c"
		}
		break;
	case PROP_STARTUP_NF:
		{
...
#line 439 "xfce-mixer-preferences.c"
		}
		break;
	default:
/* Apparently in g++ this is needed, glib is b0rk */
...
#line 106 "mixer-preferences.gob"
...
{
#line 127 "mixer-preferences.gob"
...
#line 556 "xfce-mixer-preferences.c"
#undef __GOB_FUNCTION__
...
#line 563 "xfce-mixer-preferences.c"
{
...
#line 175 "mixer-preferences.gob"
	g_return_if_fail (XFCE_IS_MIXER_PREFERENCES (self));
#line 570 "xfce-mixer-preferences.c"
{
...
#line 233 "mixer-preferences.gob"
	g_return_if_fail (XFCE_IS_MIXER_PREFERENCES (self));
#line 642 "xfce-mixer-preferences.c"
{
#line 234 "mixer-preferences.gob"
		...
		snprintf (value, 2, "%d", self->in_terminal);
		xfce_mixer_pxml_set_prop (self->xml, "term", value);

		snprintf (value, 2, "%d", self->startup_nf);
